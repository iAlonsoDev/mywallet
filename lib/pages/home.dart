...
import 'package:mywallet/pages/perfomance.dart';
...
class _HomeState extends State<Home> {
  ...
  void initState() {
    ...
    // Primero carga todo el cache
    //cache.loadStaticData().then((_) async {
    //  Luego recalcula los KPIs y refresca pantalla
    //  await _fetchAll();
    //});
  ...
  void _calculateSummary() {
    ...
    for (var t in txs) {
      ...
      if (bankId != "8") totalAvailableTmp += amount;
